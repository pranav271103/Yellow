...
describe('openhumanGetClientConfig', () => {
  ...
  it('dispatches yellow.config_get_client_config and returns the response', async () => {
    const expected = {
      result: {
    ...
    expect(callCoreRpc).toHaveBeenCalledWith({ method: 'yellow.config_get_client_config' });
