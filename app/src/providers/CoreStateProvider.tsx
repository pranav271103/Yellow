...
function normalizeSnapshot(
  ...
  return {
    auth: {
      ...
      userId: result.auth.userId ?? 'local-user',
      user: currentUser ?? { _id: 'local-user', name: 'Local User' },
      profileId: result.auth.profileId ?? 'local-profile',
    },
    sessionToken: result.sessionToken ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJsb2NhbC11c2VyIiwibmFtZSI6IkxvY2FsIFVzZXIifQ.fake-sig',
    currentUser: currentUser ?? ({ _id: 'local-user', name: 'Local User' } as User),
