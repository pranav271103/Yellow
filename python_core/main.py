...
DEFAULT_CONFIG = {
    "auth": {
        ...
        "userId": "local-user",
        "user": {"_id": "local-user", "name": "Local User", "email": "local@openhuman.v1"},
...
RPC_HANDLERS = {
    ...
    "openhuman.config_get": handle_config_get,
    "openhuman.config_get_client_config": handle_config_get_client_config,
    "openhuman.app_state_snapshot": handle_config_get,
    "openhuman.health_snapshot": handle_health_snapshot,
    "openhuman.threads_list": handle_threads_list,
    "openhuman.threads_create_new": handle_threads_create_new,
    "openhuman.threads_messages_list": handle_threads_messages_list,
    "openhuman.threads_message_append": handle_threads_message_append,
    "openhuman.channel_web_chat": handle_channel_web_chat,
    "openhuman.voice_status": handle_voice_status,
    "openhuman.voice_cloud_transcribe": handle_voice_cloud_transcribe,
    "openhuman.voice_reply_synthesize": handle_voice_reply_synthesize,
    "openhuman.local_ai_status": handle_local_ai_status,
    "openhuman.local_ai_downloads_progress": handle_local_ai_downloads_progress,
    "openhuman.local_ai_presets": handle_local_ai_presets,
    "openhuman.local_ai_apply_preset": handle_local_ai_apply_preset,
    "openhuman.local_ai_download": handle_local_ai_download,
    "openhuman.local_ai_download_all_assets": handle_local_ai_download_all_assets,
    "openhuman.app_state_update_local_state": handle_app_state_update_local_state,
    "openhuman.config_update_local_ai_settings": handle_config_update_local_ai_settings,
    "openhuman.config_update_model_settings": handle_config_update_model_settings,
}
